...
#define BOARD_NAME                      ORQA_H743
#define MANUFACTURER_ID                 ORQA
#define SYSTEM_HSE_MHZ                  8

/* Two ICM42688P IMUs, one on SPI1 and one on SPI4. */
#define USE_ACC
...
/* Motor, servo, and beeper outputs. */
...
/* Status LEDs. PA11 is USB D-, so the second LED is PA10. */
#define LED0_PIN                        PA8
#define LED1_PIN                        PA10
#define LED2_PIN                        PD11

/* Exposed UARTs. The T2/R2-labelled pads are MCU USART3. */
...
/* microSD on SDMMC1 in four-bit mode. */
#define USE_SDCARD
...
/* Camera switch, assigned to USER4 as in the recovered factory config. */
#define PINIO1_PIN                      PD0
#define PINIO1_CONFIG                   1
#define PINIO1_BOX                      43
#define BOX_USER4_NAME                  "CAM SWITCH"

/* Board defaults recovered from the factory Betaflight configuration. */
...
#define DEFAULT_FEATURES                (FEATURE_TELEMETRY | FEATURE_OSD | FEATURE_GPS | FEATURE_ESC_SENSOR)
...
#define TIMER_PIN_MAPPING \
    TIMER_PIN_MAP( 0, MOTOR1_PIN, 1,  6) /* PD12 / TIM4_CH1  */ \
    TIMER_PIN_MAP( 1, MOTOR2_PIN, 1,  7) /* PD13 / TIM4_CH2  */ \
    TIMER_PIN_MAP( 2, MOTOR3_PIN, 2,  3) /* PA1  / TIM2_CH2  */ \
    TIMER_PIN_MAP( 3, MOTOR4_PIN, 2,  2) /* PA0  / TIM2_CH1  */ \
    ...
    TIMER_PIN_MAP(10, BEEPER_PIN, 1, -1) /* PE9  / TIM1_CH1  */
